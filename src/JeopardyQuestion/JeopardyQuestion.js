    ...
    render() {
        ...
        return (
            <div className="JeopardyQuestion__jContainer">
                ...
                <p><b>Category:</b> {currentQuestion.category}</p>
                <p><b>Value:</b> {currentQuestion.value}</p>
                <form class="jeo-q-form" onSubmit={e => this.handleSubmit(e, currentQuestion.answer, currentQuestion.value)}>
                    <fieldset>
                        <legend>{currentQuestion.question}</legend>
                        <label for="answer-input">What is </label>
